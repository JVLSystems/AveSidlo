...
/** source: /var/www/html/avesidlo/app/ClientModule/Presenters/templates/@layout.latte */
final class Template32d2405e57 extends Latte\Runtime\Template
{
...
<head>
    ...
    <link href="';
		...
		echo '/adm/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.2.8" rel="stylesheet" type="text/css">
    <link href="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 11 */;
		echo '/adm/assets/plugins/global/plugins.bundle.css?v=7.2.8" rel="stylesheet" type="text/css">
    <link href="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 12 */;
		echo '/adm/assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.2.8" rel="stylesheet" type="text/css">
    <link href="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 13 */;
		echo '/adm/assets/css/style.bundle.css?v=7.2.8" rel="stylesheet" type="text/css">
    ...
    <script src="';
		...
		echo '/adm/assets/plugins/global/plugins.bundle.js?v=7.2.8"></script>
    <script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 33 */;
		echo '/adm/assets/plugins/custom/prismjs/prismjs.bundle.js?v=7.2.8"></script>
    <script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 34 */;
		echo '/adm/assets/js/scripts.bundle.js?v=7.2.8"></script>
    <!--end::Global Theme Bundle-->
    <!--begin::Page Vendors(used by this page)-->
    <script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 37 */;
		echo '/adm/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js?v=7.2.8"></script>
    <!--end::Page Vendors-->
    <!--begin::Page Scripts(used by this page)-->
    <script src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 40 */;
		echo '/adm/assets/js/pages/widgets.js?v=7.2.8"></script>
    ...
    <script src="';
		...
		echo '/adm/assets/js/pages/bootstrap-select.js"></script>
...
<body id="kt_body" style="background-image: url(';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::escapeCss($basePath)) /* line 88 */;
		echo '/adm/assets/media/bg/bg-10.jpg)" class="quick-panel-right demo-panel-right offcanvas-right header-fixed subheader-enabled page-loading">
';
		$iterations = 0;
		foreach ($flashes as $flash) /* line 89 */ {
            ...
            Swal.fire({
                title: ';
			echo LR\Filters::escapeJs($flash->type == 'success' ? 'Úspech!' : 'Chyba!') /* line 92 */;
			echo ',
                text: ';
			echo LR\Filters::escapeJs($flash->message) /* line 93 */;
			echo ',
                icon: ';
			echo LR\Filters::escapeJs($flash->type) /* line 94 */;
			echo ',
                timer: 2000
            });
        </script>
';
		...
		echo "\n";
		$this->renderBlock($ʟ_nm = 'content', [], 'html') /* line 100 */;
		echo '
