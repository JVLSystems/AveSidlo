...
/** source: /var/www/html/avesidlo/app/ClientModule/Presenters/templates/Company/edit.latte */
final class Template6ec50fe5e8 extends Latte\Runtime\Template
{
...
';
		...
		echo '">Upraviť spoločnosť ';
		echo LR\Filters::escapeHtmlText($company->getName()) /* line 24 */;
		echo '</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card card-custom gutter-b">
                                <div class="card-header">
                                    <div class="card-title">
                                        <h3 class="card-label">
                                            Upraviť spoločnosť ';
		echo LR\Filters::escapeHtmlText($company->getName()) /* line 37 */;
		echo '
                                        </h3>
                                    </div>
                                </div>
...
';
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" v-model="company.ico" @change="searchICO" placeholder="Zadajte IČO vašej spoločnosti..."';
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" v-model="company.dic" placeholder="DIČ"';
		...
		echo '>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" v-model="company.icdph" placeholder="IČDPH"';
		...
		echo '>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" v-model="company.name" placeholder="Názov vašej spoločnosti"';
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" v-model="company.street" placeholder="Adresa vašej spoločnosti"';
		...
		echo '>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" v-model="company.city"';
                                        ...
                                        <div class="row">
                                            <div class="col-md-8">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker" data-size="7" data-live-search="true" v-model="company.state"';
		$ʟ_input = $_input = end($this->global->formsStack)["states"];
		echo $ʟ_input->getControlPart()->addAttributes(['class' => null, 'data-size' => null, 'data-live-search' => null, 'v-model' => null])->attributes() /* line 121 */;
		echo '>';
		...
		echo '</select>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" v-model="company.zip"';
...
<script>
    new Vue({
        ...
        mounted() {
            ...
            var _this = this
            axios.get(';
		echo LR\Filters::escapeJs($this->global->uiControl->link("getData!", ['id' => $company->getId()])) /* line 173 */;
		echo ')
        ...
        methods: {
            searchICO() {
                if (this.company.ico.length > 3) {
                    this.isSpinning = true
                    var link = ';
		echo LR\Filters::escapeJs($this->global->uiControl->link("search!", ['ico'=>'replaceICO'])) /* line 183 */;
		echo '
                    var _this = this
