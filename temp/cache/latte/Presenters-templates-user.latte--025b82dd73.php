...
/** source: /var/www/html/avesidlo/app/ClientModule/Presenters/templates/user.latte */
final class Template025b82dd73 extends Latte\Runtime\Template
{

	public function main(): array
	{
		extract($this->params);
		echo '<!-- begin::User Panel-->
<div id="kt_quick_user" class="offcanvas offcanvas-right p-10">
    ...
    <div class="offcanvas-content pr-5 mr-n5">
		...
		echo LR\Filters::escapeHtmlAttr(LR\Filters::escapeCss($basePath)) /* line 16 */;
		echo '/adm/assets/media/users/300_21.jpg\')"></div>
                <i class="symbol-badge bg-success"></i>
            </div>
            <div class="d-flex flex-column">
                <a href="#" class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary">';
		echo LR\Filters::escapeHtmlText($loginUser->getName()) /* line 20 */;
		echo '</a>
                <div class="text-muted mt-1">';
		echo LR\Filters::escapeHtmlText($loginUser->toRole()) /* line 21 */;
		echo '</div>
                <div class="navi mt-2">
								...
								<span class="navi-link p-0 pb-2">
									<span class="navi-icon mr-1">
										<span class="svg-icon svg-icon-lg svg-icon-primary">
											<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 27 */;
		echo '/adm/assets/media/svg/icons/Communication/Mail-notification.svg-->
		...
		echo LR\Filters::escapeHtmlText($loginUser->getEmail()) /* line 38 */;
		echo '</span>
								</span>
                    </a>
                    <a class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5" href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("logout!")) /* line 41 */;
		echo '">Odhlásiť sa</a>
                </div>
            </div>
        </div>
		...
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Client:default")) /* line 52 */;
		echo '">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
							<span class="svg-icon svg-icon-md svg-icon-success">
								<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 57 */;
		echo '/adm/assets/media/svg/icons/General/Notification2.svg-->
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
									<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
										<rect x="0" y="0" width="24" height="24"></rect>
            ...
            <a class="navi-item" href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Order:default")) /* line 99 */;
		echo '">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
