...
/** source: /var/www/html/avesidlo/vendor/ublaboo/datagrid/src/templates/datagrid.latte */
final class Template2323e81209 extends Latte\Runtime\Template
{
	protected const BLOCKS = [
		...
		'snippet' => ['grid' => 'blockGrid', 'gridSnippets' => 'blockGridSnippets', 'table' => 'blockTable', 'exports' => 'blockExports1', 'thead-group-action' => 'blockThead_group_action', 'tbody' => 'blockTbody1', 'items' => 'blockItems', 'pagination' => 'blockPagination1', 'summary' => 'blockSummary'],
	];
...
';
			...
			if ($this->hasBlock($filter_block)) /* line 49 */ {
				$this->renderBlock($ʟ_nm = $filter_block, ['filter' => $f, 'input' => $form['filter'][$f->getKey()], 'outer' => TRUE] + [], 'html') /* line 50 */;
			}
			else /* line 51 */ {
				if ($this->hasBlock($filter_type_block)) /* line 52 */ {
					$this->renderBlock($ʟ_nm = $filter_type_block, ['filter' => $f, 'input' => $form['filter'][$f->getKey()], 'outer' => TRUE] + [], 'html') /* line 53 */;
				}
				else /* line 54 */ {
...
';
					...
					$this->renderBlock($ʟ_nm = 'column-header', ['column' => $visibility['column']] + get_defined_vars(), 'html') /* line 118 */;
					echo '													</a>
';
				}
				else /* line 120 */ {
...
';
					...
					$this->renderBlock($ʟ_nm = 'column-header', ['column' => $visibility['column']] + get_defined_vars(), 'html') /* line 123 */;
					echo '													</a>
';
				}
				echo '											</li>
...
';
		...
		foreach ($iterator = $ʟ_it = new LR\CachingIterator($columns, $ʟ_it ?? null) as $key => $column) /* line 144 */ {
			...
			if ($this->hasBlock($col_header)) /* line 152 */ {
				$this->renderBlock($ʟ_nm = $col_header, ['column' => $column] + [], 'html') /* line 153 */;
			}
			else /* line 154 */ {
				if ($column->isSortable()) /* line 155 */ {
					...
					echo '>
';
					$this->renderBlock($ʟ_nm = 'column-header', ['column' => $column] + get_defined_vars(), 'html') /* line 157 */;
					echo "\n";
...
';
					...
					$this->renderBlock($ʟ_nm = 'column-header', ['column' => $column] + get_defined_vars(), 'html') /* line 170 */;
				}
			}
			echo '
			...
			foreach ($iterator = $ʟ_it = new LR\CachingIterator($columns, $ʟ_it ?? null) as $key => $column) /* line 200 */ {
				...
				if (!$control->hasOuterFilterRendering() && isset($filters[$key])) /* line 204 */ {
					...
					if ($this->hasBlock($filter_block)) /* line 210 */ {
						$this->renderBlock($ʟ_nm = $filter_block, ['filter' => $filters[$key], 'input' => $i, 'outer' => FALSE] + [], 'html') /* line 211 */;
					}
					else /* line 212 */ {
						if ($this->hasBlock($filter_type_block)) /* line 213 */ {
							$this->renderBlock($ʟ_nm = $filter_type_block, ['filter' => $filters[$key], 'input' => $i, 'outer' => FALSE] + [], 'html') /* line 214 */;
						}
						else /* line 215 */ {
	...
	public function blockColumn_value(array $ʟ_args): void
	{
		...
		if ($column->hasTemplate()) /* line 520 */ {
			...
			if ($this->hasBlock($col)) /* line 523 */ {
				$this->renderBlock($ʟ_nm = $col, ['item' => $item] + [], 'html') /* line 524 */;
			}
			else /* line 525 */ {
	...
	public function blockItems(array $ʟ_args): void
	{
		...
		try {
			if ($inlineAdd && $inlineAdd->isPositionTop()) /* line 234 */ {
				$this->renderBlock($ʟ_nm = 'inlineAddRow', ['columns' => $columns] + get_defined_vars(), 'html') /* line 235 */;
			}
			echo "\n";
			if ($columnsSummary && $columnsSummary->getPositionTop()) /* line 238 */ {
				$this->renderBlock($ʟ_nm = 'columnSummary', get_defined_vars(), 'html') /* line 239 */;
			}
			echo "\n";
			$iterations = 0;
...
';
							...
							foreach ($iterator = $ʟ_it = new LR\CachingIterator($columns, $ʟ_it ?? null) as $key => $column) /* line 252 */ {
								...
								elseif ($inlineEdit->showNonEditingColumns()) /* line 266 */ {
									$this->renderBlock($ʟ_nm = 'column-value', ['column' => $column, 'row' => $row, 'key' => $key] + get_defined_vars(), 'html') /* line 267 */;
								}
								echo '											';
...
';
							...
							foreach ($iterator = $ʟ_it = new LR\CachingIterator($columns, $ʟ_it ?? null) as $key => $column) /* line 286 */ {
								...
								echo "\n";
								$this->renderBlock($ʟ_nm = 'column-value', ['column' => $column, 'row' => $row, 'key' => $key] + get_defined_vars(), 'html') /* line 291 */;
								echo '											';
...
';
								$this->renderBlock($ʟ_nm = 'detail', array_merge([], $item_detail_params, []) + [], 'html') /* line 333 */;
								echo '												</div>
											</td>
';
							}
...
';
			...
			if ($inlineAdd && $inlineAdd->isPositionBottom()) /* line 353 */ {
				$this->renderBlock($ʟ_nm = 'inlineAddRow', ['columns' => $columns] + get_defined_vars(), 'html') /* line 354 */;
			}
			echo "\n";
			if (($columnsSummary && !$columnsSummary->getPositionTop()) || $control->hasSomeAggregationFunction()) /* line 357 */ {
				$this->renderBlock($ʟ_nm = 'columnSummary', get_defined_vars(), 'html') /* line 358 */;
			}
			echo "\n";
...
';
			...
			if ($columnsSummary && $columnsSummary->someColumnsExist($columns)) /* line 453 */ {
				$this->renderBlock($ʟ_nm = 'columnsSummary', ['columns' => $columns] + get_defined_vars(), 'html') /* line 454 */;
			}
			echo "\n";
			if ($control->hasSomeAggregationFunction()) /* line 457 */ {
				$this->renderBlock($ʟ_nm = 'aggregationFunctions', ['columns' => $columns] + get_defined_vars(), 'html') /* line 458 */;
			}
			echo "\n";
