...
/** source: /var/www/html/avesidlo/app/ClientModule/Presenters/templates/Homepage/default.latte */
final class Templatea71f2be371 extends Latte\Runtime\Template
{
...
';
		$this->createTemplate('../header.latte', $this->params, 'include')->renderToContentType('html') /* line 9 */;
		echo '
            <!--begin::Content-->
                    ...
                    <div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
                        ...
                        <div class="d-flex align-items-center flex-wrap mr-1">
                            ...
                            <div class="d-flex flex-column">
                                <!--begin::Title-->
                                <h2 class="text-white font-weight-bold my-2 mr-5">Nástenka</h2>
                                <!--end::Title-->
                                <!--begin::Breadcrumb-->
		...
		echo '">
                                    ...
                                    <a href="" class="text-white text-hover-white opacity-75 hover-opacity-100">Nástenka</a>
                                </div>
                                <!--end::Breadcrumb-->
                            </div>
                            <!--end::Heading-->
		...
		echo '/adm/assets/media/svg/misc/006-plurk.svg" alt="" class="h-50">
                                                        </div>
                                                    </div>
                                                    <div>
		...
		echo '/adm/assets/media/svg/misc/015-telegram.svg" alt="" class="h-50">
                                                        </div>
                                                    </div>
                                                    <div>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                <div class="d-flex align-items-center mr-2">
                                                    <div class="symbol symbol-50 symbol-light mr-3 flex-shrink-0">
                                                        <div class="symbol-label">
                                                            <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 179 */;
		echo '/adm/assets/media/svg/misc/003-puzzle.svg" alt="" class="h-50">
                                                        </div>
                                                    </div>
                                                    <div>
                            ...
                            <div class="col-xl-8">
                                <div class="row">
                                    <div class="col-xl-3">
                                        ...
                                        <div class="card card-custom bgi-no-repeat bgi-no-repeat bgi-size-cover gutter-b" style="height: 150px; background-image: url(';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::escapeCss($basePath)) /* line 201 */;
		echo '/adm/assets/media/bg/bg-9.jpg)">
                                            <!--begin::Body-->
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        ...
                                        <div class="card card-custom bgi-no-repeat gutter-b" style="height: 175px; background-color: #663259; background-position: calc(100% + 0.5rem) 100%; background-size: 100% auto; background-image: url(';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::escapeCss($basePath)) /* line 231 */;
		echo '/adm/assets/media/svg/patterns/taieri.svg)">
                                            <!--begin::Body-->
                                                ...
                                                <div class="card card-custom bg-primary gutter-b" style="height: 150px">
                                                    <div class="card-body">
																<span class="svg-icon svg-icon-3x svg-icon-white ml-n2">
																	<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 249 */;
		echo '/adm/assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                                                ...
                                                <div class="card card-custom gutter-b" style="height: 150px">
                                                    <div class="card-body">
																<span class="svg-icon svg-icon-3x svg-icon-success">
																	<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 270 */;
		echo '/adm/assets/media/svg/icons/Communication/Group.svg-->
																	<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																		<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="card card-custom bgi-no-repeat bgi-size-cover gutter-b card-stretch" style="background-image: url(';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::escapeCss($basePath)) /* line 290 */;
		echo '/adm/assets/media/stock-600x600/img-16.jpg)">
                                            <!--begin::Body-->
                                            <div class="card-body d-flex flex-column align-items-start justify-content-start">
                                                ...
                                                <a href=\'#\' class="btn btn-link btn-link-warning font-weight-bold">Create Report
                                                    <span class="svg-icon svg-icon-lg svg-icon-warning">
															<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 299 */;
		echo '/adm/assets/media/svg/icons/Navigation/Arrow-right.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	<polygon points="0 0 24 0 24 24 0 24"></polygon>
                                        ...
                                        <div class="card-toolbar">
                                            <a href="#" class="btn btn-success font-weight-bolder font-size-sm">
													<span class="svg-icon svg-icon-md svg-icon-white">
														<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 434 */;
		echo '/adm/assets/media/svg/icons/Communication/Add-user.svg-->
														<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
															<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																<polygon points="0 0 24 0 24 24 0 24"></polygon>
		...
		echo '/adm/assets/media/svg/avatars/001-boy.svg" class="h-75 align-self-end" alt="">
																		</span>
                                                        </div>
                                                    </td>
                                                    <td class="pl-0">
                                                    ...
                                                    <td class="pr-0 text-right">
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 504 */;
		echo '/adm/assets/media/svg/icons/General/Settings-1.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 517 */;
		echo '/adm/assets/media/svg/icons/Communication/Write.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 530 */;
		echo '/adm/assets/media/svg/icons/General/Trash.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pr-0">
                                                        <div class="symbol symbol-50 symbol-light mt-1">
																		<span class="symbol-label">
																			<img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 553 */;
		echo '/adm/assets/media/svg/avatars/018-girl-9.svg" class="h-75 align-self-end" alt="">
																		</span>
                                                        </div>
                                                    </td>
                                                    <td class="pl-0">
                                                    ...
                                                    <td class="pr-0 text-right">
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 579 */;
		echo '/adm/assets/media/svg/icons/General/Settings-1.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 592 */;
		echo '/adm/assets/media/svg/icons/Communication/Write.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 605 */;
		echo '/adm/assets/media/svg/icons/General/Trash.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
		...
		echo '/adm/assets/media/svg/avatars/047-girl-25.svg" class="h-75 align-self-end" alt="">
																		</span>
                                                        </div>
                                                    </td>
                                                    <td class="pl-0">
                                                    ...
                                                    <td class="pr-0 text-right">
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 654 */;
		echo '/adm/assets/media/svg/icons/General/Settings-1.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 667 */;
		echo '/adm/assets/media/svg/icons/Communication/Write.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 680 */;
		echo '/adm/assets/media/svg/icons/General/Trash.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pr-0">
                                                        <div class="symbol symbol-50 symbol-light mt-1">
																		<span class="symbol-label">
																			<img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 703 */;
		echo '/adm/assets/media/svg/avatars/014-girl-7.svg" class="h-75 align-self-end" alt="">
																		</span>
                                                        </div>
                                                    </td>
                                                    <td class="pl-0">
                                                    ...
                                                    <td class="pr-0 text-right">
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 729 */;
		echo '/adm/assets/media/svg/icons/General/Settings-1.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm mx-3">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 742 */;
		echo '/adm/assets/media/svg/icons/Communication/Write.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
                                                        ...
                                                        <a href="#" class="btn btn-icon btn-light btn-hover-primary btn-sm">
																		<span class="svg-icon svg-icon-md svg-icon-primary">
																			<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 755 */;
		echo '/adm/assets/media/svg/icons/General/Trash.svg-->
																			<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																				<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																					<rect x="0" y="0" width="24" height="24"></rect>
                                            ...
                                            <div class="d-flex align-items-center pr-2 mb-6">
                                                ...
                                                <div class="symbol symbol-50">
															<span class="symbol-label bg-light-light">
																<img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 792 */;
		echo '/adm/assets/media/svg/misc/006-plurk.svg" class="h-50 align-self-center" alt="">
															</span>
                                                </div>
                                            </div>
                                            <!--end::Info-->
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#" class="symbol symbol-45 symbol-light mr-3">
                                                <div class="symbol-label">
                                                    <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 812 */;
		echo '/adm/assets/media/svg/avatars/001-boy.svg" class="h-75 align-self-end" alt="">
                                                </div>
                                            </a>
                                            <!--end::Pic-->
                                            ...
                                            <a href="#" class="symbol symbol-45 symbol-light mr-3">
                                                <div class="symbol-label">
                                                    <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 819 */;
		echo '/adm/assets/media/svg/avatars/028-girl-16.svg" class="h-75 align-self-end" alt="">
                                                </div>
                                            </a>
                                            <!--end::Pic-->
                                            <!--begin::Pic-->
                                            <a href="#" class="symbol symbol-45 symbol-light">
                                                <div class="symbol-label">
                                                    <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 826 */;
		echo '/adm/assets/media/svg/avatars/024-boy-9.svg" class="h-75 align-self-end" alt="">
                                                </div>
                                            </a>
                                            <!--end::Pic-->
                                        </div>
                                        ...
                                        <div class="flex-grow-1 pb-5">
                                            ...
                                            <div class="d-flex align-items-center pr-2 mb-6">
                                                ...
                                                <div class="symbol symbol-50">
															<span class="symbol-label bg-light-light">
																<img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 848 */;
		echo '/adm/assets/media/svg/misc/015-telegram.svg" class="h-50 align-self-center" alt="">
															</span>
                                                </div>
                                            </div>
                                            <!--end::Info-->
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#" class="symbol symbol-45 symbol-light mr-3">
                                                <div class="symbol-label">
                                                    <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 867 */;
		echo '/adm/assets/media/svg/avatars/001-boy.svg" class="h-75 align-self-end" alt="">
                                                </div>
                                            </a>
                                            <!--end::Pic-->
                                            ...
                                            <a href="#" class="symbol symbol-45 symbol-light mr-3">
                                                <div class="symbol-label">
                                                    <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 874 */;
		echo '/adm/assets/media/svg/avatars/028-girl-16.svg" class="h-75 align-self-end" alt="">
                                                </div>
                                            </a>
                                            <!--end::Pic-->
		...
		echo '/adm/assets/media/svg/avatars/024-boy-9.svg" class="h-75 align-self-end" alt="">
                                            ...
                                            <a href="#" class="symbol symbol-45 symbol-light">
                                                <div class="symbol-label">
                                                    <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 888 */;
		echo '/adm/assets/media/svg/avatars/005-girl-2.svg" class="h-75 align-self-end" alt="">
                                                </div>
                                            </a>
                                            <!--end::Pic-->
                                        </div>
                                        ...
                                        <div class="flex-grow-1 pb-5">
                                            ...
                                            <div class="d-flex align-items-center pr-2 mb-6">
                                                ...
                                                <div class="symbol symbol-50">
															<span class="symbol-label bg-light-light">
																<img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 910 */;
		echo '/adm/assets/media/svg/misc/003-puzzle.svg" class="h-50 align-self-center" alt="">
															</span>
                                                </div>
                                            </div>
                                            <!--end::Info-->
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="#" class="symbol symbol-45 symbol-light mr-3">
                                                <div class="symbol-label">
                                                    <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 928 */;
		echo '/adm/assets/media/svg/avatars/001-boy.svg" class="h-75 align-self-end" alt="">
                                                </div>
                                            </a>
                                            <!--end::Pic-->
                                            ...
                                            <a href="#" class="symbol symbol-45 symbol-light mr-3">
                                                <div class="symbol-label">
                                                    <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 935 */;
		echo '/adm/assets/media/svg/avatars/028-girl-16.svg" class="h-75 align-self-end" alt="">
                                                </div>
                                            </a>
                                            <!--end::Pic-->
                                            ...
                                            <a href="#" class="symbol symbol-45 symbol-light">
                                                <div class="symbol-label">
                                                    <img src="';
		echo LR\Filters::escapeHtmlAttr(LR\Filters::safeUrl($basePath)) /* line 942 */;
		echo '/adm/assets/media/svg/avatars/024-boy-9.svg" class="h-75 align-self-end" alt="">
                                                </div>
                                            </a>
                                            <!--end::Pic-->
                                        ...
                                        <div class="d-flex align-items-center mb-9 bg-light-warning rounded p-5">
                                            ...
                                            <span class="svg-icon svg-icon-warning mr-5">
														<span class="svg-icon svg-icon-lg">
															<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 1280 */;
		echo '/adm/assets/media/svg/icons/Home/Library.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	<rect x="0" y="0" width="24" height="24"></rect>
                                        ...
                                        <div class="d-flex align-items-center bg-light-success rounded p-5 mb-9">
                                            ...
                                            <span class="svg-icon svg-icon-success mr-5">
														<span class="svg-icon svg-icon-lg">
															<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 1308 */;
		echo '/adm/assets/media/svg/icons/Communication/Write.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	<rect x="0" y="0" width="24" height="24"></rect>
                                        ...
                                        <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-9">
                                            ...
                                            <span class="svg-icon svg-icon-danger mr-5">
														<span class="svg-icon svg-icon-lg">
															<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 1336 */;
		echo '/adm/assets/media/svg/icons/Communication/Group-chat.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	<rect x="0" y="0" width="24" height="24"></rect>
                                        ...
                                        <div class="d-flex align-items-center bg-light-info rounded p-5">
                                            ...
                                            <span class="svg-icon svg-icon-info mr-5">
														<span class="svg-icon svg-icon-lg">
															<!--begin::Svg Icon | path:';
		echo LR\Filters::escapeHtmlComment($basePath) /* line 1364 */;
		echo '/adm/assets/media/svg/icons/General/Attachment2.svg-->
															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																	<rect x="0" y="0" width="24" height="24"></rect>
...
';
		$this->createTemplate('../footer.latte', $this->params, 'include')->renderToContentType('html') /* line 1404 */;
		echo '        </div>
        <!--end::Wrapper-->
    </div>
    <!--end::Page-->
...
';
		$this->createTemplate('../user.latte', $this->params, 'include')->renderToContentType('html') /* line 1412 */;
