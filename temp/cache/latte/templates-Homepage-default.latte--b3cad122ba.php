...
/** source: /var/www/html/avesidlo/app/FrontModule/Presenters/templates/Homepage/default.latte */
final class Templateb3cad122ba extends Latte\Runtime\Template
{
...
<div class="banner-area auto-height bg-cover-bottom home-banner">
    <div class="container">
		...
		echo '/assets/img/illustration/8.png" alt="Thumb">
                </div>
            </div>
        </div>
    </div>
...
<div class="benifits-area reverse default-padding">
    <div class="container">
		...
		echo '/assets/img/illustration/44.png" alt="Thumb">
            </div>
		...
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Register:default")) /* line 62 */;
		echo '">Začnite teraz</a>
            </div>
...
<div class="services-area default-padding bottom-less">
    ...
    <div class="shape-bottom">
		...
		echo '/assets/img/shape/12.png" alt="Shape">
    </div>
    <!-- Fixed Shape  -->
    <div class="container">
        <div class="row">
...
<div class="pricing-area default-padding" id="pricelist">
    <div class="container">
                    ...
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="pricing-item">
                            <ul>
                                ...
                                <li class="footer">
                                    <a class="btn circle btn-dark border btn-sm" href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Register:default")) /* line 232 */;
		echo '">Založiť teraz</a>
                                </li>
                            </ul>
                        </div>
                    </div>
		...
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Register:default")) /* line 258 */;
		echo '">Začnite teraz</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 single-item">
                        <div class="pricing-item">
                            <ul>
                                ...
                                <li class="footer">
                                    <a class="btn circle btn-dark border btn-sm" href="';
		echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("Register:default")) /* line 282 */;
		echo '">Založiť teraz</a>
                                </li>
                            </ul>
                        </div>
...
';
		$this->createTemplate('../footer.latte', $this->params, 'include')->renderToContentType('html') /* line 293 */;
